...
public final class SafeKryo extends Kryo {
  ...
  public void setRegistrationRequired(boolean registrationRequired) {
    // Registration is always required for SafeKryo. Accept `true` as a no-op so this
    // class can stand in for a regular Kryo wherever explicit registration is expected.
